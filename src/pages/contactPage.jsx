  ...
  return (
    <div className="relative min-h-screen flex flex-col text-[#521B41]">
      ...
      <main className="flex-grow py-8 px-4">
        <div className="max-w-4xl mx-auto bg-white bg-opacity-90 shadow-xl rounded-2xl p-8 backdrop-filter backdrop-brightness-95">
          ...
          <div className="space-y-6 text-lg">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  href="https://facebook.com/crystelbeautyclear"
                  target="_blank"
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  href="https://youtube.com/@crystelbeautyclear"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  href="https://instagram.com/crystelbeautyclear"
                  target="_blank"
                  rel="noopener noreferrer"
